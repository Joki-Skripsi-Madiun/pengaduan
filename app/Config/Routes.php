...
$routes->get('laporan/prestasi/kelas/print', 'Laporan::prestasi', ['filter' => 'auth']);
$routes->post('laporan/prestasi/kelas/print', 'Laporan::printPrestasiKelas', ['filter' => 'auth']);
...
$routes->get('laporan/pelanggaran/kelas/print', 'Laporan::index', ['filter' => 'auth']);
$routes->post('laporan/pelanggaran/kelas/print', 'Laporan::printPelanggaranKelas', ['filter' => 'auth']);
