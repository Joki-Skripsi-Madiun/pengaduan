...
<body>
    <div class="container mt-3">
        <?php if (user()->status == 3) { ?>
            <form action="/accTugas/updateTugas/<?= $tugas['id_tugas']; ?>" method="post" class="d-inline">
                <input type="hidden" name="status_tugas" value="1">
                <button type="submit" class="d-none d-sm-inline-block btn btn-sm btn-success shadow-sm">Setujui Surat</button>
            </form>

            <form action="/accTugas/updateTugas/<?= $tugas['id_tugas']; ?>" method="post" class="d-inline">
                <input type="hidden" name="status_tugas" value="0">
