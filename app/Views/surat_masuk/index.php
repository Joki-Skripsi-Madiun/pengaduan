...
<div class="container-fluid">
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
        ...
        <?php if (session()->get('role') == 1) { ?>
            <a class="btn btn-primary" href="<?= base_url(); ?>/surat-masuk/create">Tambah Surat</a><?php } ?>
                ...
                <tbody>
                    ...
                    foreach ($surat->getResult() as $a) : ?>
                        <tr>
                            ...
                            <td><?= $a->asal_surat; ?></td>
                            <td><?= $a->nama_jenis; ?></td>
                            <td><a href="/surat-masuk/show/<?= $a->id_surat; ?>" class="btn btn-badge"><i class="bi bi-file-earmark-pdf-fill text-danger"></i></a></td>
                            <td><?= date("d-m-Y", strtotime($a->created_at)); ?></td>
                            <td>
                                <?php if (in_groups(user_id()) == 1) { ?>
                                    <a href="/surat-masuk/edit/<?= $a->id_surat; ?>" class="d-none d-sm-inline-block btn btn-sm btn-info shadow-sm"><i class="fas fa-edit fa-sm text-white-50"></i> Ubah</a>
                                    ...
                                    <form action="/surat-masuk/delete/<?= $a->id_surat; ?>" method="post" class="d-inline">
                                        <?= csrf_field(); ?>
